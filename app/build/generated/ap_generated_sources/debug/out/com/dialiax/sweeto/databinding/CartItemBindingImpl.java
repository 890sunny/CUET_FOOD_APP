...
public class CartItemBindingImpl extends CartItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cartFoodName, 2);
        sViewsWithIds.put(R.id.cartitemPrice, 3);
        sViewsWithIds.put(R.id.minusButton, 4);
        sViewsWithIds.put(R.id.cartItemQuantity, 5);
        sViewsWithIds.put(R.id.plusbutton, 6);
        sViewsWithIds.put(R.id.deleteButton, 7);
    }
    // views
    @NonNull
