...
public class FragmentHistoryBindingImpl extends FragmentHistoryBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recentBuyItem, 3);
        sViewsWithIds.put(R.id.buyAgainFoodImage, 4);
        sViewsWithIds.put(R.id.buyAgainFoodName, 5);
        sViewsWithIds.put(R.id.buyAgainFoodPrice, 6);
        sViewsWithIds.put(R.id.orderStatus, 7);
        sViewsWithIds.put(R.id.receivedButton, 8);
        sViewsWithIds.put(R.id.textView19, 9);
        sViewsWithIds.put(R.id.BuyAgainRecyclerView, 10);
    }
    // views
    @NonNull
