...
public class MenuItemBindingImpl extends MenuItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cardView6, 1);
        sViewsWithIds.put(R.id.menuImage, 2);
        sViewsWithIds.put(R.id.menuPrice, 3);
        sViewsWithIds.put(R.id.menuAddtocart, 4);
        sViewsWithIds.put(R.id.menuFoodName, 5);
    }
    // views
    @NonNull
